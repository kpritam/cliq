...
<Tabs>
  <TabItem value="anthropic" label="Anthropic (Claude)" default>
    **Best for:** Tool use, following instructions precisely, coding tasks
    
    **Models:** 
    - `claude-sonnet-4-5-20251001` (recommended, $3/M input tokens)
    - `claude-haiku-4-5-20251015` (fastest, cheapest, $0.25/M input tokens)
    
    **Setup:** `ANTHROPIC_API_KEY=sk-ant-...`
  </TabItem>
  <TabItem value="openai" label="OpenAI (GPT-4)">
    **Best for:** General knowledge, creative tasks, broad capabilities
    
    **Models:**
    - `gpt-4-turbo` (balanced performance)
    - `gpt-4` (highest capability)
    
    **Setup:** `OPENAI_API_KEY=sk-...`
  </TabItem>
